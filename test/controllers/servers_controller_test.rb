...
class ServersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create server" do
    assert_difference('Server.count') do
      post servers_url, params: { server: { name: @server.name, public_ip: @server.public_ip } }
    end
  ...
  test "should update server" do
    patch server_url(@server), params: { server: { name: @server.name, public_ip: @server.public_ip } }
