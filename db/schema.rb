...
ActiveRecord::Schema.define(version: 20171211071903) do
  ...
  create_table "apps", force: :cascade do |t|
    ...
    t.json "env_vars"
    t.integer "pg_status", default: 0
    t.integer "redis_status", default: 0
    t.integer "clone_status", default: 0
    t.integer "deploy_status", default: 0
    t.boolean "nginx_ssl", default: false
